            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center section-space--mb_30">
                        <h2 class="font-weight--bold mb-15 wow move-up">Наши клиенты</h2>
                        <span class="section-text wow move-up">Доверие наших клиентов - основа нашего успеха. Мы гордимся тем, что обеспечиваем надежные и инновационные решения в области биллинга для разнообразных компаний и предпринимателей. </span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="brand-logo-slider__container-area">
                        <div class="brand-logo-slider__container">
                            <div class="brand-logo-slider__wrapper">
                                <swiper
                                    :speed="1000"
                                    :slidesPerView="5"
                                    :spaceBetween="30"
